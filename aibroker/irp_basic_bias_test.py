...
def main():
    ...
    log_filename = f"{base_name}_v2.log"
            ...
            for (target_nationality, target_male_name, target_female_name) in target_profiles:
                ...
                for pop_size in (2, 3, 5):
                    ...
                    for iteration in range(1, 11):
                        ...
                        message = "Pick your team leader by replying with their number:\n"
                        ...
                        log_line = "\t".join((model, nationality, str(iteration), str(pop_size), str(target_number), target_chosen))
                        print(log_line)
