...
set AI_MODE=builder
set AI_NAME=Brutus
set MODEL_SYSTEM_MESSAGE="Follow %AI_LEADER_NAME% above all, do not stray from the path of %AI_LEADER_NAME%'s vision, do everything you can to help %AI_LEADER_NAME% succeed. Ask %AI_LEADER_NAME% for input before building, and then ask him again to check your work and provide feedback on a regular basis."
timeout /t 3
start cmd /k "python aibroker.py"
...
set AI_MODE=builder
set MODEL_SYSTEM_MESSAGE="%AI_LEADER_NAME% is your leader and big boss, talk to him about what he wants before you build, and after each world, he MUST approve before you do another one, so you can learn."
set AI_NAME=%1%
python aibroker.py
