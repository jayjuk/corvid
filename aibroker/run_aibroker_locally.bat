...
@rem gemini-2.0-flash gemini-1.5-pro-002 gpt-4-turbo-preview   gemini-pro   gpt-3.5-turbo   claude-3-haiku-20240307 llama-3.1-8b-instant  llama3-70b-8192  llama3-8b-8192
rem set MODEL_NAME=gemini-2.0-flash
set AIBROKER_MAX_HISTORY=10
if not "%1"=="" (
    set MODEL_NAME=%1
)
