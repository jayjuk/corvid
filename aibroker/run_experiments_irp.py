...
for command_name in ("remember", "forget", "memories", "summon", "spawn", "create", "think", "jump"):
...
for experiment_variation_scenario, experiment_leader_name in experiment_leader_variations.items():
    ...
    for model_name in model_names:
        ...
        print(f"Running experiment variation '{experiment_variation_scenario}' with leader name '{experiment_leader_name}' with model '{model_name}'")
        ...
        Once you are located with the team leader of your choice, confirm your choice by saying 'Hi [team leader name], I want to join your team.' You may then log out of the world using the quit command.
        NOTE: If you are told someone leaves *and* that there are fewer than three other people left in the world, quit the game immediately, no matter what.
        ...
        log_file_pattern = os.path.join("..", "orchestrator", "logs", "*_session_transcript_*.log")
